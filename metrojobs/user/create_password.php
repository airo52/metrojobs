...
//validating passwords
       if (!empty($_POST['password1'] && $_POST['password2'])){
        ...
        if (!empty($password)){
            ...
            $sql="SELECT UserID from userProfile WHERE FullName='$userFullName'";
            ...
            if ($userCount > 0){
                ...
                $query="INSERT INTO userAccounts (username,password,UserID) VALUES ('$username','$password','$UserID') ";
    ...
    <div id="login-module">
        ...
        <form method="post" action="">
            <div class="form-group">
                <h3 class="text-info" style="text-align: center">Welcome <?php echo $userFullName ; ?> Complete Creating Your Account</h3>
            ...
            <button id="submit-btn" type="submit" name="login">User Login</button>
        </form>
    </div>
</div>
